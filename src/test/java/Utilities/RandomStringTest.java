 ...
 *        <p><li> header for char array = 12 bytes 
 *        <p><li> String bytes = n*2 bytes where n is the actual number of chars in the String
 *    </ul>
 * 
 ...
 * <p> <li> header for char array + String bytes = 12 bytes + 34 bytes = 46 bytes
 * 
 * <p><li> RoundedUpToMultOf8( 46 ) = 48 bytes
 * 
 * <p><li> Total String byte usage = 48 bytes + 24 bytes of char array reference
 *                                               = 72 bytes total
 * </ol>
 */
