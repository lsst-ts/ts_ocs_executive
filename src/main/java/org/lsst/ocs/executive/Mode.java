 ...
 * <h2>Mode</h2>
 * <p>
 * {@code Mode} is a Context class implementation
 */
public class Mode implements DomainObject {
  ...
  public void modeState( ModeState modeState ) {
  ...
  public void startNight() {
    _entity.getMode().modeState().startNight( _entity );
  }
  ...
  public void endNight() {
    _entity.getMode().modeState().endNight( _entity );
  }
