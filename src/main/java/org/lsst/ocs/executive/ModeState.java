...
public interface ModeState extends DomainObject {
  ...
  default public void startNight( Entity entity ) {
    out.println( "error" );
  }

  default public void endNight( Entity entity ) {
    out.println( "error" );
  }
  //default public void startNight() { out.println("error"); }
  //default public void endNight()   { out.println("error"); }

  default public void scienceNight() {
    out.println( "error" );
  }

  default public void engineeringNight() {
    out.println( "error" );
  }

  default public void maintenanceNight() {
    out.println( "error" );
  }

  default public void calibrationNight() {
    out.println( "error" );
  }
