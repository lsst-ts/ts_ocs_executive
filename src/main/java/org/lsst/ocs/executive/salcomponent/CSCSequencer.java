...
/**
 *
 * CSCSequencer is OCS Executive's interface to SAL middle-ware 
 for Sequencer commands
 *
 */

public class CSCSequencer extends CommandableSalComponent {

    @Override public String getName() { return "SalCmdSequencer"; }

    @Override public void enterControl() {

        //out.println("CSCSequencer.enterControl");
