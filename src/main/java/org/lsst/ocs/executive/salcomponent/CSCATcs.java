 ...
 * <p>
 * {@code CSCATcs} is a (Concrete) Receiver class in the command pattern
 *
 */

public class CSCATcs implements CommandableSalComponent {
    
    @Override public String getName() { return "CSCATcs"; }
