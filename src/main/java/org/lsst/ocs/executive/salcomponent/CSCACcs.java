 ...
 * <p>
 * {@code CSCACcs} is a (Concrete) Receiver class in the command pattern
 * 
 */

public class CSCACcs implements CommandableSalComponent {

    @Override public String getName() { return "CSCACcs"; }
