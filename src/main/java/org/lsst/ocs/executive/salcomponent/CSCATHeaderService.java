 ...
 */
public class CSCATHeaderService implements CommandableSalComponent {

  @Override
  public String getName() {
    return "CSCATHeaderService";
  }
  ...
  public void enterControl( Object[] args ) {
    ...
    command.private_revCode = "LSST DM ATHeaderService enterControl COMMAND";
    command.device = "ATHeaderService";
  ...
  public void start( Object[] args ) {
    ...
    command.private_revCode = "LSST DM ATHeaderService start COMMAND";
    command.device = "ATHeaderService";
  ...
  public void enable( Object[] args ) {
    ...
    command.private_revCode = "LSST DM ATHeaderService enable COMMAND";
    command.device = "ATHeaderService";
  ...
  public void disable( Object[] args ) {
    ...
    command.private_revCode = "LSST DM ATHeaderService disable COMMAND";
    command.device = "ATHeaderService";
  ...
  public void standby( Object[] args ) {
    ...
    command.private_revCode = "LSST DM ATHeaderService standby COMMAND";
    command.device = "ATHeaderService";
  ...
  public void exitControl( Object[] args ) {
    ...
    command.private_revCode = "LSST DM ATHeaderService exitControl COMMAND";
    command.device = "ATHeaderService";
      ...
      if ( status == SAL_ATHeaderService.SAL__OK ) {
        ...
        try {
          Executive.getEntityMap()
              .get( EntityType.ATHEADERSERVICE.toSubString() )._modelStateTransitionQ.put( event.summaryState );

          Executive.getEntityMap()
              .get( EntityType.ATHEADERSERVICE.toSubString() )._viewStateTransitionQ.put( event.summaryState );
