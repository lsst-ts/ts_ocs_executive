...
public class TakeImageController implements Initializable {
    ...
    @FXML private SplitMenuButton numImagesMenub, exposeTimeMenub;
    
    @FXML private CheckBox shutterCheck, scienceCheck, guideCheck, wfsCheck;
    ...
    @FXML private void handleApply( ActionEvent event ) {
        ...
        argsMap.put( "1imageName"   , imageNameText.getText() /*String*/ );
        argsMap.put( "2numImages"   , Integer.parseInt( numImagesMenub.getText() /*integer*/ ));
        argsMap.put( "3exposureTime", Double.parseDouble( exposeTimeMenub.getText() /*double*/ ));
        argsMap.put( "4shutter"     , shutterCheck.isSelected() /*boolean*/ );
        argsMap.put( "5science"     , scienceCheck.isSelected() /*boolean*/ );
        argsMap.put( "6guide"       , guideCheck.isSelected() /*boolean*/ );
        argsMap.put( "7wfs"         , wfsCheck.isSelected() /*boolean*/ );
    ...
    @FXML private void handleSend( ActionEvent event ) {
        ...
        SalCmd salCmd = new SalCmd( _exec.getCscMap().get( EntityType.ACCS.toString() ));
